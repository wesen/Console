...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Sun Feb 10 13:31:55 2013
# Project:  Console.pro
# Template: lib
# Command: /usr/local/Cellar/qt/4.8.4/bin/qmake -spec /usr/local/Cellar/qt/4.8.4/mkspecs/unsupported/macx-clang -o Makefile Console.pro
#############################################################################
...
AR            = ar cq
RANLIB        = ranlib -s
QMAKE         = /usr/local/Cellar/qt/4.8.4/bin/qmake
TAR           = tar -cf
COMPRESS      = gzip -9f
COPY          = cp -f
SED           = sed
...
Makefile: Console.pro  /usr/local/Cellar/qt/4.8.4/mkspecs/unsupported/macx-clang/qmake.conf /usr/local/Cellar/qt/4.8.4/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Cellar/qt/4.8.4/mkspecs/unsupported/macx-clang -o Makefile Console.pro
