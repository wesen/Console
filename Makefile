...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Sun May 5 20:30:56 2013
# Project:  Console.pro
# Template: app
...
CC            = clang
CXX           = clang++
DEFINES       = -DCONSOLE_LIBRARY -DQT_SCRIPT_LIB -DQT_CORE_LIB -DQT_SHARED
...
INCPATH       = -I/usr/local/qt/mkspecs/unsupported/macx-clang -I. -I/usr/local/qt/include/QtCore -I/usr/local/qt/include/QtScript -I/usr/local/qt/include -I-I/usr/local/opt/flex/include -Ivendor/qextserialport/src -I.
LINK          = clang++
LFLAGS        = -headerpad_max_install_names -arch x86_64
LIBS          = $(SUBLIBS)  -L/usr/local/qt/lib -L/usr/local/lib -lreadline.6.2 -lhistory.6.2 -L/usr/local/opt/flex/lib -lfl -framework IOKit -framework CoreFoundation -lQtScript_debug -L/usr/local/qt/lib -lQtCore_debug 
AR            = ar cq
RANLIB        = ranlib -s
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Console1.0.0/ && $(COPY_FILE) --parents cmd.l .tmp/Console1.0.0/ && $(COPY_FILE) --parents console.h commandinterpreter.h filelogger.h qsignalcatcher.h Console_global.h helpers.h lcdinterpreter.h vendor/qextserialport/src/qextserialport.h vendor/qextserialport/src/qextserialenumerator.h vendor/qextserialport/src/qextserialport_global.h vendor/qextserialport/src/qextserialport_p.h vendor/qextserialport/src/qextserialenumerator_p.h .tmp/Console1.0.0/ && $(COPY_FILE) --parents console.cpp commandinterpreter.cpp filelogger.cpp qsignalcatcher.cpp lcdinterpreter.cpp main.cpp vendor/qextserialport/src/qextserialport.cpp vendor/qextserialport/src/qextserialenumerator.cpp vendor/qextserialport/src/qextserialport_unix.cpp vendor/qextserialport/src/qextserialenumerator_osx.cpp .tmp/Console1.0.0/ && (cd `dirname .tmp/Console1.0.0` && $(TAR) Console1.0.0.tar Console1.0.0 && $(COMPRESS) Console1.0.0.tar) && $(MOVE) `dirname .tmp/Console1.0.0`/Console1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Console1.0.0
